...
first_node = nodes.BrainNode(parent=None,location=start_pos,processor=pBrain)
second_node = nodes.BrainNode(parent=first_node,location=second_pos,processor=pBrain)
#weed = plant.Plant(start_pos,nodes.BrainNode)
